...
const FeatureCircle: React.FC = () => {
  return (
    <div className="flex flex-col items-center bg-backgroundColor py-72 relative">
      ...
      {/* Features */}
      <div className="relative w-full h-auto mt-[-220px] flex flex-wrap justify-center lg:justify-between space-x-4">
        {/* Feature 1 */}
        ...
        {/* Feature 3 */}
        <div className="flex flex-col items-center text-center rounded-full shadow-lg w-56 h-56 p-6 bg-orange-300 mb-8 lg:absolute lg:top-[550px] lg:left-[640px]">
          <div className="text-4xl">🍎</div>
          <p className="mt-4 text-base font-semibold text-white">
