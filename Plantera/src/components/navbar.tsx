    ...
    <div className="fixed w-full top-0 z-50 backdrop-blur-md shadow-md py-3 px-10">
      ...
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="flex space-x-6 text-sm">
          <div className="text-[#000000] hover:text-green-600 font-medium cursor-pointer transition duration-300">
            Home
          </div>
          <div className="text-[#5B4e2] hover:text-green-600 font-medium cursor-pointer transition duration-300">
            About
          </div>
